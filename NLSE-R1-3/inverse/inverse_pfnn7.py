...
class Subnet1(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x2_1 = torch.tanh(self.fc2_1(x1))
        x2_2 = torch.tanh(self.fc2_2(x1))

        x3_1 = torch.tanh(self.fc3_1(x2_1))
        x3_2 = torch.tanh(self.fc3_2(x2_1))
        x3_3 = torch.tanh(self.fc3_3(x2_2))
        x3_4 = torch.tanh(self.fc3_4(x2_2))
...
class Subnet5(torch.nn.Module):
    def __init__(self, num_neurons=32, num_layers=4):
...
class MainNet(torch.nn.Module):
    def __init__(self, subnet1_neurons=2 ** 5 * 2, subnet2_neurons=2 ** 4 * 2, subnet3_neurons=2 ** 4 * 2):
        super(MainNet, self).__init__()
        # self.subnet1 = Subnet1(num_neurons=subnet1_neurons)
        self.subnet1 = BS_net(num_neurons=subnet1_neurons, input_num=2, output_num=2, num_layers=4)

        # self.even_subnet = Subnet2(num_neurons=subnet2_neurons)
        self.subnet2 = Subnet5(num_neurons=subnet2_neurons, num_layers=4)
        self.subnet3 = Subnet6(num_neurons=subnet3_neurons, num_layers=4)
